/**
 * Modified Johnson-Steinhaus-Trotter algorithm (taken from https://github.com/nodash/steinhaus-johnson-trotter) to generate all permutation of a given list. Permutations are generated by incrementally swapping pairs of elements. We support passing a custom swapping function with a custom type.
 * That is, because permutations of a correction must adjust their indices to preserve semantic equivalence to the original correction.
 */
